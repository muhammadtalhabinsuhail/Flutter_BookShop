...
// //                                   height: 6,
// //                                   decoration: BoxDecoration(
// //                                     color: (widget.product.isAvailable ?? 0) > 0 ? Colors.green : Colors.red,
// //                                     shape: BoxShape.circle,
// //                                   ),
// //                                 ),
...
// //                                 Flexible(
// //                                   child: Text(
// //                                     (widget.product.isAvailable ?? 0) > 0 ? 'Available' : 'Not Available',
// //                                     style: TextStyle(
// //                                       fontSize: 10,
// //                                       color: (widget.product.isAvailable ?? 0) > 0 ? Colors.green : Colors.red,
...
// //                           ],
// //                         ),
// //                         if ((widget.product.isAvailable ?? 0) > 0)
// //                           AddToCartButton(
...
//     return GestureDetector(
//       onTap: widget.onTap,
//       onDoubleTap: _isUserLoggedIn ? _handleDoubleTap : null, // Only enable double tap if logged in
//       child: Stack(
//         children: [
//           Container(
//             decoration: BoxDecoration(
...
//                         ),
//
//                         // Animated Heart Icon (only show if user is logged in)
//                         if (_isUserLoggedIn)
//                           Positioned(
//                             top: 8,
//                             right: 8,
...
//           ),
//
//           // Big Heart Animation Overlay (only show if user is logged in)
...
//             ),
//
//           // Double-tap hint overlay for logged out users
//           if (!_isUserLoggedIn)
//             Positioned(
//               top: 8,
//               right: 8,
