...
import 'package:project/Screens/Customer/Wishlist/wishlist_screen.dart';
    ...
    return Container(
      ...
      child: Column(
        children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          height: 6,
                          decoration: BoxDecoration(
                            color: widget.item.product.isAvailable > 0 ? Colors.green : Colors.red,
                            shape: BoxShape.circle,
                          ),
                        ),
                        const SizedBox(width: 4),
                        Text(
                          widget.item.product.isAvailable > 0 
                              ? 'Available (${widget.item.product.isAvailable} left)'
                              : 'Out of Stock',
                          style: TextStyle(
                            fontSize: 12,
                            color: widget.item.product.isAvailable > 0 ? Colors.green : Colors.red,
          ...
          // Add to Cart Button
          if (widget.item.product.isAvailable > 0)
            SizedBox(
              width: double.infinity,
