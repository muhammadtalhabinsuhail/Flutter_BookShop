...
// import 'package:project/Screens/Customer/SignUp/SignUpController.dart';
...
//                   validator: (value) {
//                     if (value!.isEmpty) {
//                       return controller.textBoxValidator(value,fieldName: 'Email');// ya custom mana funct banaya ha
//                     }
//                     if (!RegExp(
...
//
//                     if (value!.isEmpty) {
//                       return controller.textBoxValidator(value,fieldName: 'Password');  // ya custom mana funct banaya ha
//                     }
//
//                     if (!RegExp(
