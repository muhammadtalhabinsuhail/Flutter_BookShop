...
// import 'package:project/Screens/Admin/AdminDashboard/AdminDashboardView.dart';
...
//                               context,
//                               MaterialPageRoute(
//                                 builder: (context) => AdminDashboard(selectedIndex: 0),//selectedIndex: 0
//                               ),
//                             );
//                             break;
//                           case 1:
...
//                               context,
//                               MaterialPageRoute(
//                                 builder: (context) => CategoryManagementScreen(),//selectedIndex: 2
//                               ),
//                             );
//                             break;
//
...
//                               context,
//                               MaterialPageRoute(
//                                 builder: (context) => CustomerListsScreen(selectedIndex: 4),
//                               ),
//                             );
//                             break;
//
...
//                             //   context,
//                             //   MaterialPageRoute(
//                             //     builder: (context) => ProductsScreen(selectedIndex: 5),
//                             //   ),
//                             // );
//                             break;
//
...
//                             //   context,
//                             //   MaterialPageRoute(
//                             //     builder: (context) => ProductsScreen(selectedIndex: 6),
//                             //   ),
//                             // );
//                              break;
//                         }
...
//           _isDarkMode = isDark;
//         });
//         // You should handle actual app theme change from root
//       },
//       child: Container(
...
class _AdminDrawerState extends State<AdminDrawer> {
  ...
  final List<NavItem> _navItems = [
    ...
    NavItem(Icons.inventory_2_outlined, Icons.inventory_2, 'Products'),
    NavItem(Icons.category_outlined, Icons.category, 'Category'),
    NavItem(Icons.favorite_outline, Icons.favorite, 'Wishlist'), // NEW WISHLIST ITEM
    NavItem(Icons.store_outlined, Icons.store, 'Shop'),
    NavItem(Icons.people_outlined, Icons.people, 'Customers'),
    NavItem(Icons.campaign_outlined, Icons.campaign, 'Promote'),
  ];
